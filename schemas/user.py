...
class UserRegister(BaseModel):
    ...
    password: str = Field(..., min_length=63, max_length=65, description="明文密码")
...
class PasswordEdit(BaseModel):
    old_password: str = Field(..., min_length=63,
                              max_length=65, description="旧密码")
    new_password: str = Field(..., min_length=63,
                              max_length=65, description="新密码")


# 更改邮箱
class EmailEdit(BaseModel):
    password: str = Field(..., min_length=63, max_length=65,
...
class PortraitResponse(BaseModel):
    ...
    filekey: str = Field(..., description="头像的相对路径 URL",
                         examples=["/static/avatars/abc123.png"])
