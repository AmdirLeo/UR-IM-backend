...
@router.post(
    "/register/forgetpswdsend", response_model=BaseResponse, summary="忘记密码申请"
)
...
@router.post(
    "/register/forgetpswdset", response_model=BaseResponse, summary="忘记密码修改"
)
...
async def edit_profile(
    edit_data: UserEdit, current_user_id: CurrentUserId, conn: DBConnection
):
